    ...
    >
      ...
      {archived.length === 0 ? (
        ...
        >
          ...
          <p className="text-muted-foreground/60 text-xs mt-1">Use the menu on any bookmark to archive it</p>
        </motion.div>
      ) : (
          ...
          <AnimatePresence mode="popLayout">
            {archived.map((bookmark) => (
              ...
              >
                ...
                <span className="text-xs text-muted-foreground hidden sm:block flex-shrink-0">{bookmark.createdAt}</span>
                <button
